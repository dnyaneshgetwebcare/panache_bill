...
class BookingHeader extends \yii\db\ActiveRecord
{
    ...
    public $diplay_amount,$picked_up,$cancel_flag,$pending_amount;
    /**
     * {@inheritdoc}
     */
