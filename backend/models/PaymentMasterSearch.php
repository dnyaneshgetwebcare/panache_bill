...
class PaymentMasterSearch extends PaymentMaster
{
     ...
     * {@inheritdoc}
     */
     public $customer_name,$month_year_filter,$from_date,$to_date,$search_cust;
    public function rules()
    {
        return [
            [['payment_id', 'amount', 'booking_id'], 'integer'],
            [['date', 'type', 'mode_of_payment', 'received_by', 'received_during', 'dom', 'sendto','customer_name','month_year_filter','from_date','to_date','search_cust'], 'safe'],
        ];
    }
