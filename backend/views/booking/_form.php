...
<input type="text" id="customermastersearch-name" class="form-control text_first"  placeholder="Search by Name/Contact nos or Create New" autocomplete="off" style="display: none;" onkeyup="customerchange(this.value,this.id)">
                      ...
                      <div class="col-md-2"><button type="button" class="btn btn-info" onclick="showsearch()"><span class="fa fa-edit"></span>  </button></div>
        ...
        foreach ($booking_items as $indexHouse => $booking_item): 
            ...
            <tr class="house-item" id='<?php echo "bookingitem-{$indexHouse}-test";?>'>
                ...
                <td class="text-center vcenter" style="width: 90px; verti">
                    ...
                    <button type="button" class="remove-house btn btn-danger btn-xs" onclick="removeBookingitem()" <?php echo ($item_status)?'disabled':''; ?>><span class="fa <?= ($item_status)?'fa-truck':'fa-minus' ?>"></span></button>
                   <?php if($item_status){ ?> 
                   <button style="margin-top: 5px;" type="button" class="btn btn-danger btn-xs" onclick="<?php echo ($item_status)?'cancel_pickup('.$model->booking_id.','.$booking_item->item_id.',\''.$booking_item->item_status.'\')':''; ?>" title="Cancel Pickup" ><span class="fa fa-ban"></span></button> 
               <?php } ?>
                </td>
            </tr>
         <?php endforeach; ?>
