...
<div class="col-lg-12 name_input_field search_field" id='<?php echo "itemselection-item_name"; ?>'>
  ...
  <div class="col-lg-6 name_input_field " style="padding-right:0px">
    ...
    <i class="glyphicon glyphicon-menu-down items-icon" onclick="changeitemdetails('','itemselection-description')"
       style="font-size: 11px;padding:5px;position: absolute;right:0;margin: 3px 60px 0 0"></i>
  ...
  <span class="glyphicon glyphicon-remove slider-close cancel_button pull-right"
        style="margin:7px 0px 10px 10px;cursor:pointer;color: #000000"></span>
