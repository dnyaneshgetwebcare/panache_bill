...
<div class="row page-titles">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="<?php echo Yii::$app->request->baseUrl.'/index.php?r=booking/delivery&id='.$model->booking_id ?>">Delivery Items</a>
            <a class="dropdown-item" href="<?php echo Yii::$app->request->baseUrl.'/index.php?r=booking/return-item&id='.$model->booking_id ?>">Return Item</a>
