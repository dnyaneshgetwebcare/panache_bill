...
/* @var $searchModel backend\models\DisplayTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Display Types';
...
<script type="application/javascript">
    function addnewItem() {
        ...
        $.ajax({
            url:"<?php echo \Yii::$app->getUrlManager()->createUrl('display-type/create') ?>",
            type: 'post',
            dataType:'html',
            beforeSend: function(){
                $(".overlay").show();
        ...
        $.ajax({
            url:"<?php echo \Yii::$app->getUrlManager()->createUrl('display-type/update') ?>",
            type: 'get',
            data:{
                id:type_id
               },
